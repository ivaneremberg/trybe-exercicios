...
const productTax = 20;
// let productPlusTaxes = 0;

if (productCost < 0 || productPrice < 0){
    console.log("Error:  Product cost or/and product price lower than zero (0).");
}
else {
    // productPlusTaxes = productCost + productCost * productTax / 100;
    console.log(productPrice - (productCost + ((productCost * productTax) / 100)));
}